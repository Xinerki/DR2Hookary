...
BOOL WINAPI DllMain(HINSTANCE hDllHandle, DWORD nReason, LPVOID lpvReserved)
{
	if (nReason == DLL_PROCESS_ATTACH)
	{
		...
		if (randomAddr == dr2Val)
		{
			...
			//injector::MakeCALL(0x8CA6A1, CreateWindowHk);
			//injector::MakeJMP(0x8C4D80, CreateWindowHk);
			//Call<int>(, CreateWindowHk);

			injector::MakeCALL(0xA532D0, mmmmmmno); // no more XLiveRender it die 1950-2020
			//injector::MakeNOP(0x8C4CBB, 40);
			...
			//injector::MakeCALL(0x743B26, LoadDatafile);

			//injector::MakeCALL(0x814291, idkman);
			//injector::MakeCALL(0x744925, snprintfHook);
		...
		else if (randomAddr == dr2OtrVal) 
		{
			...
			//injector::MakeCALL(0xA2EFE1, OTR_SetWindowLongW);
			//injector::MakeCALL(0xA2F040, OTR_SetWindowLongW);
			//injector::MakeCALL(0xA351E3, OTR_SetWindowLongW);
			//injector::MakeCALL(0xA352B0, OTR_SetWindowLongW);

			//injector::MakeCALL(0xA2EFCB, OTR_AdjustWindowRect);
			//injector::MakeCALL(0xA2F02C, OTR_AdjustWindowRect);
			//injector::MakeCALL(0xA35209, OTR_AdjustWindowRect);
			//injector::MakeCALL(0xA352D8, OTR_AdjustWindowRect);
			//injector::MakeNOP(0xA352CB, 19);
			//injector::MakeCALL(0xA353C9, OTR_AdjustWindowRect);
		}
		else
		{
